---
name: zephyr-power-management
description: Expert guidance on Zephyr RTOS power management. Use when working with system sleep states, runtime device power management, wake sources, PM policy constraints, low-power design, wake-latency tradeoffs, or measuring and debugging current draw in Zephyr applications and drivers.
---
...
- [../zephyr-kconfig/SKILL.md](../zephyr-kconfig/SKILL.md) for `prj.conf`, symbol dependencies, and menuconfig debugging
- [../zephyr-devicetree/SKILL.md](../zephyr-devicetree/SKILL.md) for wake-capable pins, interrupts, and board wiring
- [../zephyr-gpio/SKILL.md](../zephyr-gpio/SKILL.md) for GPIO wake interrupts
- [../zephyr-isr/SKILL.md](../zephyr-isr/SKILL.md) for ISR-safe wake handling
- [../zephyr-threading/SKILL.md](../zephyr-threading/SKILL.md) for blocking thread design, workqueues, and scheduler behavior
- [../zephyr-kernel-synchronization/SKILL.md](../zephyr-kernel-synchronization/SKILL.md) for semaphores, events, mutexes, and wait-based coordination
- [../zephyr-device-drivers/SKILL.md](../zephyr-device-drivers/SKILL.md) for driver PM callbacks and `PM_DEVICE_*` integration
...
Then enable the sleep-state support your SoC and board actually provide. Common examples shown in the slide deck include:
...
For custom drivers, follow the PM callback patterns in [../zephyr-device-drivers/references/driver-model.md](../zephyr-device-drivers/references/driver-model.md).
